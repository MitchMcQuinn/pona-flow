...
def run_startup_migrations() -> None:
    ...
    try:
        ...
        # Rebuild state.status CHECK for waiting/cancelled; add result column.
        catalog._rebuild_state_status_check(conn)
        sqlite_util.ensure_column(conn, "state", "result", "TEXT")
