 ...
 * materializing a designed HTTP STEP), which fixes the order: operations, then
...
- STEP: an executable unit — a saved query, an HTTP call, a wait, or a join.
...
1. create_operation for each step.
   ...
   For create STEP (HTTP / Wait / Join): materializes that STEP in the graph. A single new STEP
